...
namespace Framework
{
    ...
    public class FrameworkDictionary<TKey, TValue> : IDictionary<TKey, TValue>
    {
        ...
        public FrameworkDictionary()
            : this(0, null)
        {
        }

        public FrameworkDictionary(int capacity)
            : this(capacity, null)
        {
        }

        public FrameworkDictionary(IEqualityComparer<TKey> comparer)
            : this(0, comparer)
        {
        }

        public FrameworkDictionary(int capacity, IEqualityComparer<TKey> comparer)
        {
            if (capacity < 0)
        ...
        public FrameworkDictionary(IDictionary<TKey, TValue> dictionary)
            : this(dictionary, null)
        {
        }

        public FrameworkDictionary(IDictionary<TKey, TValue> dictionary, IEqualityComparer<TKey> comparer)
        ...
        {
            private readonly FrameworkDictionary<TKey, TValue> _Dictionary;
            ...
            internal Enumerator(FrameworkDictionary<TKey, TValue> dictionary)
            {
