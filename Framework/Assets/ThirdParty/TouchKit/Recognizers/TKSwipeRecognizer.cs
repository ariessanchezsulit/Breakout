...
public class TKSwipeRecognizer : TKAbstractGestureRecognizer
{
    ...
    public event System.Action<TKSwipeRecognizer> gestureBeginEvent;
    public event System.Action<TKSwipeRecognizer> gestureStayEvent;
    public event System.Action<TKSwipeRecognizer> gestureEndEvent;
    ...
    /// </summary>
    public float timeToSwipe = 0.2F; //0.5f;
    ...
    /// </summary>
    private float _minimumDistance = 2f; //2f;
    ...
    internal override void touchesMoved(List<TKTouch> touches)
    {
        ...
        if (state == TKGestureRecognizerState.Began)
        {
            ...
            if (gestureStayEvent != null)
            {
                gestureStayEvent(this);
            }
