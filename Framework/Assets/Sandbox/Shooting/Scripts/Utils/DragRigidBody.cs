...
namespace Sandbox.Shooting
{
    ...
    public class DragRigidbody : MonoBehaviour
    {
        ...
        private void Update()
        {
            ...
            if (
                !Physics.Raycast(m_Camera.ScreenPointToRay(Input.mousePosition).origin,
                                 m_Camera.ScreenPointToRay(Input.mousePosition).direction, out hit, 100,
            ...
            if (!hit.rigidbody.Equals(m_RigidBody))
            {
                return;
            }
