...
namespace Framework
{
    ...
    public abstract class FrameworkDictionaryDrawer<TK, TV> : PropertyDrawer
    {
        private FrameworkDictionary<TK, TV> _Dictionary;
        ...
        private void CheckInitialize(SerializedProperty property, GUIContent label)
        {
            if (_Dictionary == null)
            {
                ...
                _Dictionary = fieldInfo.GetValue(target) as FrameworkDictionary<TK, TV>;
                if (_Dictionary == null)
                {
                    _Dictionary = new FrameworkDictionary<TK, TV>();
    ...
    [CustomPropertyDrawer(typeof(SFXAudioMap))]
    public class SFXAudioMapDrawer : FrameworkDictionaryDrawer<SFX, AudioClip>
    {
    }

    [CustomPropertyDrawer(typeof(BGMAudioMap))]
    public class BGMAudioMapDrawer : FrameworkDictionaryDrawer<BGM, AudioClip>
    {
    }
